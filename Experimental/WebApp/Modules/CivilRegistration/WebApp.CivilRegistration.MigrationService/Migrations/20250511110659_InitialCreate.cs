...
namespace WebApp.CivilRegistration.MigrationService.Migrations
{
	...
	public partial class InitialCreate : Migration
	{
			...
			migrationBuilder
				.CreateTable(
					...
					columns: table => new
					{
						...
						DeceasedId = table.Column<Guid>(
							type: "char(36)",
							nullable: false,
							collation: "ascii_general_ci"
						),
						WidowedId = table.Column<Guid>(
							type: "char(36)",
							nullable: true,
							collation: "ascii_general_ci"
						),
			...
			migrationBuilder
				.CreateTable(
					...
					columns: table => new
					{
						...
						HusbandId = table.Column<Guid>(
							type: "char(36)",
							nullable: false,
							collation: "ascii_general_ci"
						),
						WifeId = table.Column<Guid>(
							type: "char(36)",
							nullable: false,
							collation: "ascii_general_ci"
						),
			...
			migrationBuilder
				.CreateTable(
					...
					columns: table => new
					{
						...
						StateMachineId = table.Column<Guid>(
							type: "char(36)",
							nullable: false,
							collation: "ascii_general_ci"
						),
			...
			migrationBuilder
				.CreateTable(
					...
					columns: table => new
					{
						...
						MarriageCertificateId = table.Column<Guid>(
							type: "char(36)",
							nullable: false,
							collation: "ascii_general_ci"
						),
		...
		protected override void Down(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.DropTable(name: "MaritalStatuses", schema: "WebApp_CivilRegistration");
