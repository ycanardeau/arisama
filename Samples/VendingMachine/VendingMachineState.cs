...
internal sealed record Idle : VendingMachineState, ICanInsertCoin
{
	public Coin TotalAmount { get; } = Coin.Empty;
}

internal sealed record CoinInserted(Coin Amount, Coin TotalAmount)
	: VendingMachineState,
		ICanInsertCoin,
		ICanChooseProduct,
		ICanReturnChange;

internal sealed record ProductChosen(ProductId ProductId)
	: VendingMachineState,
		ICanDispenseProduct;
